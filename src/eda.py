"""
Exploratory Data Analysis (EDA) Module for Medical Inventory Forecasting.

Provides reusable functions for inspecting product and company-level inventory insights
...
def get_low_demand_products(
    ...
    Returns (low_sales_df, count, percentage, top_n_by_qohvalue).
    """
...
def plot_low_demand_products(
    ...
    """Plot bar chart of low demand products with highest inventory value."""
    fig, ax = plt.subplots(figsize=(10, 5))
